...
namespace AirTalk.Models.ViewModels
{
    public class UserRegistrationVM
    {
        ...
        [Remote(action:"CheckLogin", controller:"Home", ErrorMessage ="This login is already in use")]
        [Display(Name = "Login")]
        public string login { get; set; }

        [EmailAddress]
        [Remote(action:"CheckEmail",controller:"Home", ErrorMessage ="This email is already in use")]
        [Display(Name = "Email")]
